...
CREATE TRIGGER DefinirAnoDeLancamentoDosFilmes
...
CREATE TRIGGER InserirLogFilme
  BEFORE INSERT ON movies
  FOR EACH ROW
BEGIN
  INSERT INTO movies_logs(movie_id, executed_action, log_date)
  VALUES(NEW.movies_id, 'INSERT', NOW());
END$$
...
CREATE TRIGGER deleteFilme
  AFTER DELETE movies
  FOR EACH ROW
BEGIN 
  INSERT INTO movies_logs(executed_action, movie_id)
  VALUES('DELETE', NEW.movie_id)
 END$$
