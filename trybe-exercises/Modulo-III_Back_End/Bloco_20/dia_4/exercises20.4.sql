...
UPDATE Movies SET director = 'Andrew Staton'
WHERE id = 9;
...
INSERT INTO BoxOffice(movie_id, rating, domestic_sales, international_sales)
VALUES(8, 8.5, 300000000, 450000000),
    ...
    DELETE FROM BoxOffice WHERE movie_id IN (SELECT id FROM Movies WHERE director = 'Andrew Staton')
